  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/4 top-20 h-72 w-72 rounded-full bg-violet-600/20 blur-[120px]" />
        <div className="absolute bottom-10 right-1/4 h-72 w-72 rounded-full bg-cyan-500/10 blur-[120px]" />
        ...
        <div className="grid w-full items-center gap-16 lg:grid-cols-[1.15fr_.85fr]">
          ...
          <div>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-4">
              ...
              <a
                href="#work"
                className="group rounded-xl bg-white px-6 py-3.5 text-sm font-bold text-slate-950 transition hover:-translate-y-0.5 hover:bg-cyan-300"
              >
                Explore my work
              ...
              <a
                ...
                className="group rounded-xl border border-white/10 bg-white/[0.04] px-6 py-3.5 text-sm font-semibold text-white backdrop-blur-sm transition hover:-translate-y-0.5 hover:border-violet-400/40 hover:bg-violet-500/10"
              >
                Download CV
                <span className="ml-2 text-violet-300 transition group-hover:translate-y-0.5">
                  ↓
                </span>
              </a>
            </div>
          ...
          <div className="relative mx-auto w-full max-w-md lg:ml-auto">
            ...
            {/* Glow */}
            <div className="absolute -inset-6 rounded-[3rem] bg-gradient-to-r from-violet-600/20 to-cyan-500/20 blur-3xl" />

            {/* Card */}
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] p-3 shadow-2xl shadow-black/40 backdrop-blur-xl">
            ...
            {/* Floating Labels */}
            <div className="absolute -left-5 top-16 hidden rounded-2xl border border-white/10 bg-[#0b1020]/90 px-4 py-3 shadow-xl backdrop-blur-xl sm:block">
            ...
            <div className="absolute -right-5 bottom-20 hidden rounded-2xl border border-cyan-400/20 bg-[#0b1020]/90 px-4 py-3 shadow-xl backdrop-blur-xl sm:block">
      ...
      <a
        href="#about"
        className="absolute bottom-8 left-1/2 hidden -translate-x-1/2 text-slate-500 transition hover:text-white md:block"
